...
const es = {
  ...
  home: {
    live: "Disponibilidad de última hora",
    ...
    posterOpenTop: "Algo acaba",
    posterOpenBottom: "de quedar libre.",
    posterActionTop: "Toca y",
    posterActionBottom: "reserva.",
  ...
  common: { nearby: "Cerca de ti", back: "Volver", save: "Guardar", cancel: "Cancelar", loading: "Cargando", error: "No hemos podido completar la acción.", language: "Idioma" },
};

const en: typeof es = {
  nav: { home: "Home", explore: "Explore", bookings: "Bookings", profile: "Profile", forBusinesses: "For businesses", login: "Log in" },
  home: {
    live: "Last-minute availability",
    ...
    posterOpenTop: "Something",
    posterOpenBottom: "just opened up.",
    posterActionTop: "Tap",
    posterActionBottom: "and book it.",
  ...
  explore: { kicker: "AVAILABILITY · LIVE", title: "Available appointments", subtitle: "Something just opened up near you.", filters: "Filters", date: "Date", category: "Category", radius: "Distance", price: "Maximum price", today: "Today", tomorrow: "Tomorrow", week: "This week", any: "Any", sort: "Sort", soonest: "Soonest", nearest: "Nearest", discount: "Biggest discount", lowestPrice: "Lowest price", loadMore: "Show more", emptyTitle: "No appointments around here yet.", emptyBody: "Try increasing the distance or checking tomorrow." },
  ...
  common: { nearby: "Near you", back: "Back", save: "Save", cancel: "Cancel", loading: "Loading", error: "We couldn't complete that action.", language: "Language" },
};
